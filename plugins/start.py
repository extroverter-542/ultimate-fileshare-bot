    ...
    if len(text) > 7:
        ...
        if len(argument) == 3:
            try:
                ...
                logger.error(f"Error parsing start/end arguments: {e}")
                return
            if start <= end:
            ...
            try:
                ...
                logger.error(f"Error parsing single id argument: {e}")
                return
        ...
        for msg in messages:
            ...
            if AUTO_DELETE_TIME and AUTO_DELETE_TIME > 0:
                try:
                    copied_msg_for_deletion = await msg.copy(chat_id=message.from_user.id, caption=caption,
                ...
                try:
                    ...
                    logger.error(f"Error copying message without auto-delete: {e}")
                    pass
...
async def get_users(client: Bot, message: Message):
    ...
    try:
        ...
        await msg.edit("Failed to retrieve user information.")
